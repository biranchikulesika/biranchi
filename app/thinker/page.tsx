...
export default async function ThinkerPage() {
  ...
  return (
    <div className="w-full font-sans dark:text-[#A7A39B] text-[#55524B] antialiased animate-fade-in">
          ...
          <div className="col-span-8 space-y-36 xl:space-y-44">
            ...
            <section id="desktop-fragments" className="scroll-mt-28">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                ...
                {fragments.map((frag) => (
                  <div key={frag.id} className="border-l border-[#E2DFDA]/60 dark:border-[rgba(255,255,255,0.02)] pl-5 py-2 hover:border-[#7E7A73]/30 dark:hover:border-[#7E7A73]/20 transition-colors duration-300">
        ...
        <div className="lg:hidden space-y-16">
            ...
            <div className="space-y-12">
              ...
              {featuredEssays.slice(0, 1).map((essay) => (
                <Link href={`/p/${essay.slug}`} key={essay.slug} className="group block select-none">
                  ...
                  <h3 className="text-2xl font-cormorant font-normal text-[#2F3134] dark:text-[#DEDAD3] tracking-wide mb-3 leading-tight">{essay.title}</h3>
                  <p className="text-[14.5px] text-[#55524B] dark:text-[#A7A39B] leading-[1.8] font-light mb-4">{essay.excerpt}</p>
                  <span className="text-[11px] font-mono text-[#7E7A73] underline underline-offset-4">Read notes &rarr;</span>
                </Link>
              ))}
              ...
              {featuredEssays.slice(1).map((essay, index) => (
                <Link href={`/p/${essay.slug}`} key={essay.slug} className="group block select-none">
                  ...
                  <h3 className="text-xl font-cormorant font-normal text-[#2F3134] dark:text-[#DEDAD3] tracking-wide mb-2">{essay.title}</h3>
                  <p className="text-[13.5px] text-[#55524B] dark:text-[#A7A39B] leading-[1.75] font-light mb-3">{essay.excerpt}</p>
                  <span className="text-[11px] font-mono text-[#7E7A73] underline underline-offset-4">Read notes &rarr;</span>
                </Link>
              ))}
            </div>
          ...
          <section id="mobile-fragments" className="border-t border-[#E2DFDA] dark:border-[rgba(255,255,255,0.03)] pt-12">
            ...
            <div className="space-y-6">
              ...
              {fragments.map((frag) => (
                <div key={frag.id} className="border-l border-[#E2DFDA]/60 dark:border-[rgba(255,255,255,0.02)] pl-4 py-1.5">
            ...
            <div className="space-y-4">
              {currentReads.length === 0 ? (
                ...
                <div key={idx} className="flex justify-between items-baseline gap-4 pb-3 border-b border-[#E2DFDA]/30 dark:border-[rgba(255,255,255,0.01)]">
                  <div>
                    <span className="text-[13px] font-sans font-light text-[#2F3134] dark:text-[#D7D4CE] block">{book.title}</span>
                    <span className="text-[10.5px] italic font-cormorant text-[#7E7A73]">by {book.author}</span>
                  </div>
                  <span className="text-[8.5px] font-mono uppercase text-[#7E7A73]">{book.status}</span>
                </div>
              ))}
              <div className="pt-2">
                <Link
